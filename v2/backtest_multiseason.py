...
def _run_season_backtest(df: pd.DataFrame, season: str, *,
    ...
    match_frame = pd.DataFrame({
        ...
        "historical_home_prior": bool(bt.USE_HISTORICAL_HOME_PRIOR),
        "home_history_seasons": int(bt.HOME_ADV_HISTORY_SEASONS),
        "home_history_decay": float(bt.HOME_ADV_HISTORY_DECAY),
